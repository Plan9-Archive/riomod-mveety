...
{
	if (bgcolour == 1)    /* Black */
		background = allocimage(display, Rect(0,0,1,1), RGB24, 1, 0x000000FF);
	else if (bgcolour == 2) /* White */
		background = allocimage(display, Rect(0,0,1,1), RGB24, 1, 0xFFFFFFFF);
	else   /* The Default Grey */
